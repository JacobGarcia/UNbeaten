...
jQuery.extend(jQuery.mobile.datebox.prototype.options.lang, {
	...
	"ar": {
		...
		"calTodayButtonLabel": "Ø§Ù„Ù‚ÙØ² Ø¥Ù„Ù‰ Ø§Ù„ÙŠÙˆÙ…",
	...
	"bg": {
		...
		"calTodayButtonLabel": "ÐžÐ±Ñ€Ð°Ñ‚Ð½Ð¾ Ð´Ð¾ Ð”Ð½ÐµÑ",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM",
		"calDateListLabel": "Ð”Ñ€ÑƒÐ³Ð¸ Ð´Ð°Ñ‚Ð¸",
		"calHeaderFormat": "%B %Y",
		"calTomorrowButtonLabel": "ÐÐ°Ð¿Ñ€Ð°Ð²Ð¾ ÐºÑŠÐ¼ ÑƒÑ‚Ñ€Ðµ"
	},
	"ca": {
	...
	"el": {
		...
		"calTodayButtonLabel": "ÎœÎµÏ„Î¬Î²Î±ÏƒÎ· ÏƒÏ„Î· ÏƒÎ·Î¼ÎµÏÎ¹Î½Î®",
		...
		"calHeaderFormat": "%B %Y",
		"calTomorrowButtonLabel": "Î†Î»Î¼Î± ÏƒÏ„Î¿ Î±ÏÏÎ¹Î¿"
	},
	"en": {
		...
		"durationLabel": [
			"Hours",/*       Se modifico days por hours*/
			"Hours",
			"Minutes",
			"Seconds"
		],
		"durationDays": [
			"Hour",/*       Se modifico Day por Hour*/
			"Hours"/*       Se modifico Days por Hours*/
		],
	...
	"ja": {
		...
		"calTodayButtonLabel": "ä»Šæ—¥ã¸ã‚¸ãƒ£ãƒ³ãƒ—",
		...
		"calHeaderFormat": "%B %Y",
		"calTomorrowButtonLabel": "æ˜Žæ—¥ã¸ã‚¸ãƒ£ãƒ³ãƒ—ã—ã¾ã™ã€‚"
	},
	"ko": {
		"setDateButtonLabel": "ë‚ ì§œ ì§€ì •",
		"setTimeButtonLabel": "ì‹œê°„ ì„¤ì •",
		"setDurationButtonLabel": "ê¸°ê°„ ì„¤ì •",
		"calTodayButtonLabel": "ì˜¤ëŠ˜ ë‚ ì§œë¡œ ì§€ì •",
	...
	"ru": {
		...
		"calHeaderFormat": "%B %Y",
		"calTomorrowButtonLabel": "ÐŸÐµÑ€ÐµÐ¹Ñ‚Ð¸ Ð½Ð° Ð·Ð°Ð²Ñ‚Ñ€Ð°"
	},
	"sl": {
	...
	"th": {
		...
		"calTodayButtonLabel": "à¸à¸¥à¸±à¸šà¹„à¸›à¸§à¸±à¸™à¸™à¸µà¹‰",
		...
		"calHeaderFormat": "%B %Y",
		"calTomorrowButtonLabel": "à¹„à¸›à¸§à¸±à¸™à¸žà¸£à¸¸à¹ˆà¸‡à¸™à¸µà¹‰"
	},
	"tr": {
	...
	"uk": {
		...
		"calTodayButtonLabel": "Ð¡ÑŒÐ¾Ð³Ð¾Ð´Ð½Ñ–",
	...
	"vi": {
		...
		"calHeaderFormat": "%B %Y",
		"calTomorrowButtonLabel": "Nháº£y Ä‘á»ƒ ngÃ y mai"
	},
	"zh-CN": {
